package co.jlabs.ordering.LikeAnimation;

/**
 * Created by JLabs on 12/30/15.
 */
...
public class LikeButtonView extends FrameLayout implements View.OnClickListener {
    ...
    public void onClick(View v) {
        isChecked = !isChecked;
        ivStar.setImageResource(isChecked ? R.drawable.ic_shopping_basket_black_24dp : R.drawable.ic_star_rate_off);
